...
// import { Pizza, LogOut, UserCircle, ShoppingCart, History } from 'lucide-react';
...
//   // Llamamos a la función totalItems() del store para obtener el número actual
...
//                     {totalItems}
//                   </span>
//                   {/* Contador textual al lado (visible en pantallas >= sm) */}
...
export default function Header() {
  ...
  // selector puede devolver un número o una función que calcule el total.
  const totalItemsSelector = useCartStore((state) => state.totalItems);
  const totalItems = typeof totalItemsSelector === 'function' ? totalItemsSelector() : totalItemsSelector ?? 0;
